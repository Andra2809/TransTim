...
import '../controller/view_all_user_ticket_controller.dart';
...
class ViewAllUserTicketScreen extends StatelessWidget {
  ViewAllUserTicketScreen({super.key});

  final ViewAllUserTicketController _controller =
      Get.put(ViewAllUserTicketController());
